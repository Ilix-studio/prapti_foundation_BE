...
exports.incrementVisitorCount = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        ...
        let visitorData = await visitorModel_1.default.findOne();
        if (!visitorData) {
            // Create new visitor counter if it doesn't exist
            visitorData = await visitorModel_1.default.create({
                totalVisitors: 1,
                lastVisit: new Date(),
                dailyVisits: [
                    {
...
exports.getVisitorCount = (0, express_async_handler_1.default)(async (req, res) => {
    try {
        const visitorData = await visitorModel_1.default.findOne();
        if (!visitorData) {
